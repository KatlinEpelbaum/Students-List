...
students.forEach((student) => {
  ...
  friendsRow.innerHTML = "<th>Friend ID</th><th>Friend Name</th>";
  ...
  friendsCell.appendChild(friendsTable);

  studentInfo.appendChild(friendsCell);
